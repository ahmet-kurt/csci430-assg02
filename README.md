...
1. Create your own private copy of the assignment repository from
   the class template repository on GitHub.  Go to the class template
   repository for 'Assignment 02: Process State Simulation' at

   https://github.com/ahmet-kurt/csci430-assg02

   and select "Use this template" -> "Create a new repository".  Make
   sure the owner is your own GitHub account, name your repository
   `assg02-lastname` (using your own last name), and set the
   repository visibility to **Private**.
2. Add the instructor as a collaborator on your new repository so that
   your work can be reviewed and evaluated.  In your repository go to
   Settings -> Collaborators -> Add people, and invite the
   instructor's GitHub account: `ahmet-kurt`.  All work for this class is
   individual work, do not add any other collaborators to your
   assignment repositories.
3. Clone the repository using the SSH URL to your local class DevBox
   development environment.
4. Confirm that the project builds and runs, though no tests will be
   defined or run initially.  If the project does not build on the first
   checkout, please inform the instructor.  Confirm that your C++
...
5. Make a small initial commit and push it to your repository, then
   open the `Feedback` pull request.  For example, add your name to
   the file header comment of one of the source files, commit the
   change, and push it to your `main` branch.  A repository action
   will automatically create a branch named `feedback` in your
   repository when you push.  On GitHub, go to Pull requests -> New
   pull request, select base: `feedback` and compare: `main`, and
   create a pull request titled `Feedback`.  Do **not** merge or close
   this pull request.  The instructor uses the `Feedback` pull request
   to review your commits and give you comments and evaluations of
   your work.  (If the `feedback` branch does not appear after your
   first push, you can create it yourself from a terminal in your
   DevContainer: `git branch feedback $(git rev-list --max-parents=0
   HEAD) && git push -u origin feedback`)
...
of your `task2` implementation and push it to your GitHub repository to be
evaluated.
...
task 3 work and push it to your GitHub repository.
...
In addition to pushing your final commits to your GitHub
repository, you must also submit your assignment in MyLeo Online (D2L)
by the due date.  In the D2L Assignments folder for this programming
assignment, submit both of the following:

1. The URL of your GitHub repository for this assignment (paste it
   into the comments field of your D2L submission).
2. A zip archive of your final repository contents.  You can create
   this archive from a terminal in your DevContainer with:
   `git archive --format=zip --output=assg02-submission.zip main`

Your GitHub repository is the primary artifact that will be reviewed
and evaluated.  The D2L submission records your official submission
time and provides a backup copy of your work.
...
These assignment materials were originally developed by Dr. Derek
Harter for CSci 430 (Introduction to Operating Systems) at East Texas
A&M University, and are used and adapted with attribution for the
Summer II 2026 section of CSCI 430 taught by Dr. Ahmet Kurt.  The
original course materials can be found at
[https://github.com/csci430-os](https://github.com/csci430-os).
